...
git clone https://github.com/your-username/api-file-conversion.git
cd api-file-conversion
...
- **Base URL**: http://localhost:8080/v1/file/
...
```bash
curl -H "Authorization: Bearer dev-file-key" \
     http://localhost:8080/v1/file/endpoint
```
...
curl -H "X-RapidAPI-Proxy-Secret: your-secret" \
     ...
     https://your-api.p.rapidapi.com/v1/file/endpoint
```
...
```bash
# Build image
docker build -t api-file-conversion .

# Run container
docker run -p 8080:8080 \
  -e FILE_CONVERSION_API_KEY=your-key \
...
2. Repository: `your-username/api-file-conversion`
...
| `FILE_CONVERSION_API_KEY` | Service API key | dev-file-key |
...
FILE_CONVERSION_API_KEY=your-development-key
```
...
FILE_CONVERSION_API_KEY=your-production-api-key
...
2. **Docker Build Issues**
   ...
   docker build --no-cache -t api-file-conversion .
   ```

3. **Environment Issues**
   ```bash
   # Check environment variables
   docker-compose logs file-conversion-api
   ```
